...
class LocalEmbeddingIndex:
    def __init__(
        ...
        self.embedding_model = build_embeddings(settings.embedding_model, settings.google_api_key)
    ...
    def build(
        ...
        embedding_model = build_embeddings(settings.embedding_model, settings.google_api_key)
